...
**Your Answers here:**
1. This is done where it concatenates SPY and AAPL, i.e. here --------> mytickers = c("SPY", "AAPL") 
2. cum. = 5.964058  ; avg  = 0.001480282 ; sd =  0.02390119
<br>
<br>
...
**Your Answers here:**
1. We can use ncol and nrow.
2.  

```{r}
plot(apply(StockReturns,1,mean))
...
**Your Answers here:**
1. we need to change the start date 
<br>
<br>
<br>
