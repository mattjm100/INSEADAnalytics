...
ProjectData <- read.csv(paste0("../Sessions23/data/", datafile_name, ".csv"))
...
# DEFAULT is 10. If the number is large the report and slides may not be generated.
max_data_report = 10
```
...
*<br>1. No, the correlations between the variables are low (no correlation <0.7). 
*<br>2. This implies that the variables are independent of each other. 
*
*
*
*
...
*<br>1. The plot shows the predictive power that each component holds. From the plot, we can see that 5 components have an eigen value greater tha the abline (1). This also means that we need at least 5 components to have a variance of > 50%. 
*<br>2. This plot has a specific shape as a few components have a higher predictive power (i.e. 5 components have a predictive power greater than 1). As we add further components, we can see that their eigen values decrease, hence the plot has a decreasing slope. No, the plot cannot be increasing - it can either be flat or decrease. 
*<br>3. Ideally, one would like to see few components having high eigen values. 
*
*
*
*
...
1. First component - Status symbol. Second component - experience. Yes makes business sense. 

2. a) We should use five factors, as this is the minimum number we need to explain over 50% of the variance. The rest of the variance may likely be noise. b) If you look at the factors we chose, there is a clear logical argument for including each of them in the analysis as they have strong correlations with questions that appear to be important purchase drivers. c) We obviously want to choose factors that are most relevant to the business question at hand, namely whether customers are likely to purchase a boat or not.

3. We would interpret the factors as following: 

 1. Status symbol
 2. Experience
 3. Brand/quality
 4. experience of the person
 5. Highly price sensitive 

4. This is an efficent way of collecting and analyzing data, however it is critical to have a robust understanding of the process, data, and analytic tools in order to adequately perform the analysis.
...
1. These types of customers see boats as a status symbol, and view boating as an adventurous activity that helps them escape. They also value reputable brands, and tend to be hobbyists. Finally, they are likely somewhat price sensitive. 

2. We would select: Component 1 - Q9 ("Status Symbol"), Component 2 - Q18 ("feeling adventure"), Q21 ("helps me escape"), Component 3 - Q4 ("reputable brand"), Component 4 - Q11 ("perform minor boat repairs on my own"), Component 5 - Q2 ("when buying a boat lowest price is more important than brand")
*
*
*
*
...
# Please use numbers, not column names, e.g. c(1:5, 7, 8) uses columns 1,2,3,4,5,7,8
segmentation_attributes_used = c(9,18,4,11,2) #c(10,19,5,12,3) 
...
<<<<<<< HEAD
1. They tell us the preferences of customers in each segment relative to the mean.
2. 

=======
*1. This represents the average score of each segment scaled with respect to the average population. I.e., this represents the distance of the segment from the population, if the segment differs from the population. Also, from this table, we can see that the segmenting questions show greater deviation than the profiling questions and are more informative. <br><br>
>>>>>>> bab9b12246d126de3a2b88e3d52a2ebea2fd16d3
*
2. 
Based on the snake plot above, some of the key features of the population includes:

 1. Status symbol: these are people who perceive the boat as a status symbol and the ownership of the boat is important to them.
 2. Experience: this category of people perceive boats as a hobby and to experience something new in their lives.
 3. Brand/quality: for this segment, the brand and quality of the boat is very important. 
 4. Knowledge/ experience of the person: this segment is well-versed with boats and can undertake repair activities themselves.
 5. Highly price sensitive: for this segment, price is of prime importance. From the data, this segment does not seem very passionate about buying a boat.
*
*
...
*1. According to statistical arguments, there are 5 segments in our market. However, after analyzing the data, only 4 of the 5 segments are likely to buy a boat. Segment 5 does not seem very passionate about any of the things associated with boating. (See previous answers). Hence, we suggest to focus our marketing effort on the remaining 4 segments. 
<br>

2. Answered previously <br>.
3. In case of iteration, the results change. However, the results don't change to that extent - i.e., the overall conclusion remains the same. 
<br>
4. Our recommendation is that as we have rich data for each of the segments, we can potentially build boats that cater to each of the segment needs. For e.g., For segment 2 (those who look at boats as gaining new experiences), we can consider making boats with differenciating factors (such as more facilities, funkier looks and branding).
*
*
*
*
